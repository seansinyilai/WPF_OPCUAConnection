...
namespace OPCUA_MethodOfCoding.Classes.Helper
{
    public class Extension
    {

        #region Private Helper Functions
        public static bool IsUnsignedAnalogType(BuiltInType builtInType)
        {
        ...
        public static bool IsAnalogType(BuiltInType builtInType)
        {
            switch (builtInType)
            {
        ...
        public static Range GetAnalogRange(BuiltInType builtInType)
        {
            switch (builtInType)
            {
                case BuiltInType.UInt16:
